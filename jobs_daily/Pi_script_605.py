...
def send_to_line(temperature, humidity, light_status):
    ...
    message = f"A5-605 溫度: {temperature}°C 濕度: {humidity}%。{light_message}詳細資料: https://thingspeak.com/channels/2327006/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line&update=15"
